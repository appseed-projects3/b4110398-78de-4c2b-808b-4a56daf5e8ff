...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-08-17 22:22`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/b4110398-78de-4c2b-808b-4a56daf5e8ff.git
$ cd b4110398-78de-4c2b-808b-4a56daf5e8ff
```
